...
## 25. Interactions between landscape level vulnerability and zoonotic outbreak risk at a global scale

Supervised by Dr Yang Liu, Centre for Mathematical Modelling of Infectious Diseases (CMMID) \@ LSHTM, co-supervised by Dr Dave Redding (Biodiversity and Health, Natural History Museum), Prof Kris Murray (MRC Unit The Gambia and Centre on Climate Change and Planetary Health \@ LSHTM), Dr. Claire Risley (Animal Disease Epidemiology, Aberystwyth University), and Dr Johanna Hanefeld, LSHTM Berlin Office, Charité Global Health centre, Universitätsmedizin Berlin. The student will also spend some time working at the WHO Pandemic Hub to develop user interfaces and develop climate-resilient outbreak management recommendations. For further information contact Dr Yang Liu -- yang.liu\@lshtm.ac.uk
