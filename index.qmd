...
[CDT Applications 2024](https://cardiff.onlinesurveys.ac.uk/onezoo-cdt-supervisor-project-proposals-2024) Once the application deadline has passed, a project selection panel comprised of at least one representative from each institution will first score then jointly scrutinise projects and select the top 40 for advertisement. You will be informed of the outcome of this process by the end of March.
